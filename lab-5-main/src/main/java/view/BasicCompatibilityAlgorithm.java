...
public interface BasicCompatibilityAlgorithm extends CompatibilityAlgorithm {
    ...
    @Override
    public default double calculateScore(Profile currentUser, Profile otherUser) {
    ...
    public default double calculateWeightedScore(Profile currentUserProfile, Profile otherProfile, Map<Integer, Double> sectionWeights) {
        double totalScore = 0.0;
